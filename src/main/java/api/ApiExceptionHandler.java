...
public class ApiExceptionHandler {
    ...
    @ExceptionHandler({AlreadyExistUserFieldException.class, AlreadyExistUserFieldException.class, NotEnoughStockException.class, InvalidProductAmountInTicketException.class})
    @ResponseBody
