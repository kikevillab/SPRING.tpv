...
public class ApiExceptionHandler {
    ...
    @ExceptionHandler({AlreadyExistUserFieldException.class, AlreadyExistUserFieldException.class, NotEnoughStockException.class, LastCashierClosureIsClosedException.class, LastCashierClosureIsOpenYetException.class})
    @ResponseBody
